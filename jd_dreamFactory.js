...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN(), res2 = await updateTuanIdsCDN("https://ghproxy.com/https://raw.githubusercontent.com/amlph/sub/main/shareCodes/jd_updateFactoryTuanId.json")
  if (!res) res = await updateTuanIdsCDN('https://ghproxy.com/https://raw.githubusercontent.com/amlph/sub/main/shareCodes/jd_updateFactoryTuanId.json');
...
function updateTuanIdsCDN(url = 'https://ghproxy.com/https://raw.githubusercontent.com/amlph/sub/main/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    const options = {
...
function requireConfig() {
  return new Promise(async resolve => {
    ...
    if ($.tuanConfigs && $.tuanConfigs['tuanActiveId']) {
      ...
      if (!$.tuanConfigs) {
        await updateTuanIdsCDN('https://ghproxy.com/https://raw.githubusercontent.com/amlph/sub/main/shareCodes/jd_updateFactoryTuanId.json');
        if ($.tuanConfigs && $.tuanConfigs['tuanActiveId']) {
          tuanActiveId = $.tuanConfigs['tuanActiveId'];
          console.log(`拼团活动ID: 获取成功 ${tuanActiveId}`)
        } else {
